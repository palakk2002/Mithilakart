  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm px-4 py-3 flex items-center justify-between">
        ...
        >
          <Plus size={22} strokeWidth={2} className="text-[#2874F0]" />
        </button>
      </div>
      ...
      <div className="px-4 py-5 max-w-2xl mx-auto space-y-5">
        ...
        <button
          onClick={() => handleOpenModal()}
          className="w-full bg-[#2874F0] text-white py-3.5 rounded-2xl font-black uppercase tracking-widest text-[13px] shadow-md shadow-blue-200 flex items-center justify-center gap-2 active:scale-95 transition-transform"
        >
        ...
        <div className="flex items-center justify-between px-1">
          <span className="text-[10px] font-black text-[#2874F0] uppercase tracking-[3px]">Your Addresses</span>
            ...
            return (
              <motion.div
                ...
                className={`bg-white rounded-2xl p-4 border cursor-pointer transition-all duration-200 ${
                  isSelected
                    ? 'border-[#2874F0] shadow-md shadow-blue-100 scale-[1.01]'
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <div className={`p-1.5 rounded-lg ${isSelected ? 'bg-[#2874F0] text-white' : 'bg-blue-50 text-[#2874F0]'}`}>
                      {addr.type === 'HOME' ? <Home size={13} strokeWidth={2} /> : <Building2 size={13} strokeWidth={2} />}
                    </div>
                    <span className={`text-[11px] font-black uppercase tracking-widest ${isSelected ? 'text-[#2874F0]' : 'text-gray-600'}`}>
                      {addr.type}
                    </span>
                    {isSelected && (
                ...
                {/* Address info */}
                <h3 className={`text-[13px] font-black mb-1 ${isSelected ? 'text-[#2874F0]' : 'text-gray-800'}`}>
                  {addr.name}
                </h3>
                ...
                <div className="flex gap-4 pt-3 mt-3 border-t border-gray-100">
                  <button
                    ...
                    className="flex items-center gap-1.5 text-[11px] font-black uppercase tracking-widest text-[#2874F0] hover:opacity-70 transition-opacity"
                  >
                    <Edit2 size={12} /> Edit
                  </button>
                  <button
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-[#2874F0] uppercase tracking-[2px] ml-1">Receiver Name</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 pl-10 pr-4 text-[13px] font-medium focus:outline-none focus:border-[#2874F0] transition-colors"
                    />
                  </div>
                </div>
                ...
                {/* Phone */}
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-[#2874F0] uppercase tracking-[2px] ml-1">Phone Number</label>
                  <div className="relative">
                ...
                {/* Address */}
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-[#2874F0] uppercase tracking-[2px] ml-1">Complete Address</label>
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 pl-10 pr-4 text-[13px] font-medium focus:outline-none focus:border-[#2874F0] transition-colors resize-none"
                    />
                  </div>
                </div>
                ...
                {/* Type */}
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-[#2874F0] uppercase tracking-[2px] ml-1">Address Type</label>
                    ...
                    {['HOME', 'WORK'].map((type) => (
                      <button
                        ...
                        className={`flex-1 py-2.5 rounded-xl border font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${
                          formData.type === type
                            ? 'bg-[#2874F0] text-white border-[#2874F0] shadow-md shadow-blue-200'
                ...
                <div className="pt-2 pb-6">
                  <button
                    onClick={handleSave}
                    className="w-full bg-[#2874F0] text-white py-3.5 rounded-2xl font-black uppercase tracking-widest text-[13px] shadow-md shadow-blue-200 active:scale-95 transition-transform"
                  >
