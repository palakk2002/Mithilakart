    ...
    <footer className="w-full bg-white pt-10 pb-20 mt-auto border-t border-gray-100 flex flex-col items-center">
      ...
      <div className="flex items-center justify-center gap-6 mb-6">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-full flex items-center justify-center bg-[#25D366] transition-transform hover:scale-110 active:scale-95 shadow-sm"
        >
          <svg className="w-5 h-5 text-white fill-current" viewBox="0 0 24 24">
      ...
      <div className="flex flex-col items-center justify-center gap-0">
        ...
        />
        <span className="text-[20px] font-black text-slate-800 tracking-wider mt-[-4px]">
          Mithilakart™
        </span>
      </div>
    </footer>
